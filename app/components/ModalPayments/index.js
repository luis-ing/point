...
const ModalPayments = ({
    ...
    useEffect(() => {
        setAmountToPay(Number(totalToPay));
    }, [totalToPay]);
    ...
    useEffect(() => {
        setReturnedInCash(Number(amountToPay - totalToPay).toFixed(2));
    }, [amountToPay]);
                ...
                <ModalContent>
                    ...
                    <form onSubmit={handlerPay}>
                        <ModalBody pb={2}>
                            ...
                            <Heading size='lg' pb={4}>{`Total a pagar ${CurrencyFormat(totalToPay)}`}</Heading>
                            ...
                            {methodSelected === 1 && (
                                <>
                                    ...
                                    <FormControl mb={4}>
                                        ...
                                        <Text fontSize='2xl'>{CurrencyFormat(returnedInCash)}</Text>
                                    </FormControl>
                        ...
                        <ModalFooter>
                            <Button
                                colorScheme="orange"
                                mr={3} type="submit"
                                isDisabled={methodSelected === 1 && !(Number(amountToPay) >= Number(totalToPay))}
